...
pr#124 (wiki(games-of-note): daily 2026-06-04) kind=requeue resolved=true — clean+green PR had no auto-merge set; enabled squash auto-merge via MCP (gh CLI unauthenticated).
