...
## [2026-08-30] manual | conflict-resolver — 7 requeued, 1 lint-fix (concurrent)

Triggered by merge of pr#652 (games-of-note). 6 orphan-CLEAN 2026-08-30 PRs requeued (#643–#648); pr#649 (agentic-coding 2026-08-29) had broken-wikilink (missing [[state-of-open-models-summer-2026-bc290ba3]] from concurrent frontier-models merge); concurrent rebase fix already landed on remote, auto-merge re-queued. pr#654 (report 2026-08-29) already merged.
