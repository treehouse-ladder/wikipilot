...
**Anthropic's new standard flagship (July 24, 2026) is [[claude-opus-5]]**, which **tops Fable 5 on most benchmarks at half the token price** — Frontier-Bench 43.3% (vs Fable 5's 33.7%), ARC-AGI-3 30.16%, OSWorld 2.0 70.57%, AutomationBench 26.0% — at unchanged Opus pricing ($5/$25 per Mtoken, vs Fable 5's $10/$50) [[anthropic-launches-claude-opus-5-its-fourth-model-in-two-months-and-it-tops-fable-5-on-most-benchmarks-7253a489]] [[meet-the-new-claude-opus-5-frontier-class-agentic-coding-and-computer-use-at-unchanged-opus-pricing-7f7892b3]]. **Fable 5 still edges Opus 5 on SWE-bench Pro (80.0%) and remains Anthropic's recommendation for the most advanced multi-day autonomous agent work** [[meet-the-new-claude-opus-5-frontier-class-agentic-coding-and-computer-use-at-unchanged-opus-pricing-7f7892b3]] [[introducing-claude-opus-5-c34a3276]].
...
**Superseded by [[claude-fable-5.1]] (September 1, 2026).** Anthropic shipped Claude Fable 5.1 (and Mythos 5.1) as the successor Mythos-class flagship: Fable 5.1 (max) scores **66 on the AA Intelligence Index (+4 over Fable 5's 62)**, taking the aggregate-index #1 slot, and gains the GDPval-AA v2 lead (1,853 Elo), Terminal-Bench v2.1 (91.4%), SciCode (62.0%), HLE (59.1% vs Fable 5's 55.5%) and +9 on τ³-Banking over Fable 5 [[claude-fable-5-1-tops-the-artificial-analysis-intelligence-index-88ebeee8]]. Fable 5.1 holds Fable 5's $10/$50 list pricing but cuts cache reads 75% to $0.25/Mtok (~25% cheaper typical / ~45% cheaper agentic workloads) [[introducing-claude-fable-5-1-and-claude-mythos-5-1-e7232d52]].

> Fable 5.1 gains +4 points on the Intelligence Index over Fable 5. On HLE, Fable 5.1 scores 59.1%, ahead of the previous best of 55.5% from Claude Fable 5. [[claude-fable-5-1-tops-the-artificial-analysis-intelligence-index-88ebeee8]]

## Disputes

- [[claude-fable-5-launches-at-1-on-the-artificial-analysis-intelligence-index-a03d0111]] claims AA Intelligence Index score 64.9 (June 11, v4.0 weighting); [[claude-opus-4-8-max-intelligence-performance-price-analysis-27b7d2eb]] reports Fable 5 (with fallback) leads at 60 on AA Intelligence Index v4.1 (June 18, agentic-reweighted). The Summary currently states 64.9 while the frontmatter records 60. Status: unresolved — the two scores reflect different index versions (v4.0 vs v4.1); the frontmatter should clarify which version it tracks, or carry both with source attribution (confidence: high; sweep: 2026-07-12).
- [[claude-fable-5-the-first-public-mythos-class-model-672c92f6]] claims GDPval-AA score 1932 (at June 9 release); [[claude-opus-4-8-max-intelligence-performance-price-analysis-27b7d2eb]] reports Fable 5 (with fallback) scored 1818 on GDPval-AA v2 (June 18). Status: unresolved — the two scores reflect different versions of GDPval-AA (original vs v2 with updated task weighting); the frontmatter records 1818 (v2) while the Summary references 1932 (original) (confidence: high; sweep: 2026-07-12).
- [[claude-fable-5-the-first-public-mythos-class-model-672c92f6]] reports Fable 5's SWE-bench Pro score as **80.3%**; [[meet-the-new-claude-opus-5-frontier-class-agentic-coding-and-computer-use-at-unchanged-opus-pricing-7f7892b3]] reports it as **80.0%**. Status: unresolved — the 0.3 pp gap may reflect benchmark version, evaluation protocol, or rounding differences between two Anthropic-sourced reports; both figures appear in this page's Summary (confidence: high; sweep: 2026-07-26).
