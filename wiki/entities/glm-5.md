...
- The Summary section cites [[glm-5-2-is-the-new-leading-open-weights-model-on-the-artificial-analysis-intelligence-index-ef3ea3a0]] to assert GLM-5.2 (AA Index 51) "now holds the open-weights #1 position"; [[glm-5-3-flash-intelligence-performance-price-analysis-b02205ef]] reports GLM-5.3-Flash at AA Index 57 "matching Kimi K3's open-weights aggregate lead", and [[kimi-k3-model-overview-2-8t-parameters-mxfp4-quantization-and-what-the-open-weights-mean-for-the-community-67bfe96b]] confirms Kimi K3 (57) as open-weights — both superseding GLM-5.2's 51. Status: unresolved — the Summary's "now holds #1" present-tense claim reflects the June 2026 state and has not been updated to reflect GLM-5.3-Flash and Kimi K3 overtaking GLM-5.2 on the open-weights leaderboard.
