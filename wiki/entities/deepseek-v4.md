...
**DeepSeek V4.1 Flash (Sep 2026)** introduces a novel Causal Encoder-Decoder (CED) architecture: 552B MoE backbone with **8B active parameters during prefill** and 16B during decode, 384 routed experts (1 shared + 6 routed per token), up to 1M-token context, and a controllable reasoning effort setting from 1 to 100 [[deepseek-ai-deepseek-v4-1-flash-5c348986]]. Pricing is **$0.30/MTok input, $1.20/MTok output** — ~83% cheaper than V4-Pro-0813's listed $1.74/$3.48 — with output at 190.1 t/s (well above the median 64.9 t/s for comparable open-weights models) and TTFT 1.00s [[deepseek-v4-1-flash-max-intelligence-performance-price-analysis-2034e17f]]. Artificial Analysis rates V4.1 Flash at **40 on the Intelligence Index** (above the open-weights-of-similar-size median of 18, but below V4-Pro-0813's 53) [[deepseek-v4-1-flash-max-intelligence-performance-price-analysis-2034e17f]]. The HuggingFace model card claims V4.1 Flash is "ahead of its much larger DeepSeek-V4-Pro on performance, cost, speed and total runtime" [[deepseek-ai-deepseek-v4-1-flash-5c348986]].

> DeepSeek-V4.1-Flash is a multimodal Mixture-of-Experts (MoE) model with 552B backbone parameters and support for contexts of up to one million tokens. The model activates only 8B parameters per token during prefill and 16B during decode. [[deepseek-ai-deepseek-v4-1-flash-5c348986]]

> DeepSeek V4.1 Flash costs $0.30 per 1M input tokens and $1.20 per 1M output tokens. [[deepseek-v4-1-flash-max-intelligence-performance-price-analysis-2034e17f]]

## Disputes

- [[deepseek-ai-deepseek-v4-1-flash-5c348986]] claims V4.1 Flash is "ahead of its much larger DeepSeek-V4-Pro on performance, cost, speed and total runtime"; [[deepseek-v4-1-flash-max-intelligence-performance-price-analysis-2034e17f]] rates V4.1 Flash at AA Intelligence Index 40 vs V4-Pro-0813's 53 — a 13-point gap in the opposite direction. These two claims are not necessarily contradictory if "performance" on the HuggingFace card refers to latency/cost metrics, but the framing is ambiguous. Status: unresolved.
...
- [ ] [[deepseek-ai-deepseek-v4-1-flash-5c348986]] claims V4.1 Flash is "ahead of V4-Pro on performance, cost, speed and total runtime," yet [[deepseek-v4-1-flash-max-intelligence-performance-price-analysis-2034e17f]] rates it at AA Intelligence Index 40 vs V4-Pro-0813's 53. On which specific metrics or benchmark sets does V4.1 Flash actually outperform V4-Pro, and is the "ahead" claim about normalized cost-efficiency rather than absolute intelligence?
